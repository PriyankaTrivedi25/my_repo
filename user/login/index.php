  ...
  <div class="form">
    ...
    <form method="post" action="signupcheck.php">
      ...
      <input type="email" placeholder="Email Address" id="email" name="email" placeholder="<?php if($flg==2)
       ...
       <input type="tel" id="num" placeholder="Enter your address" name="address" maxlength="10" />
        <label id="err_num">Please enter address</label>
       <input type="tel" id="num" placeholder="Enter your number" name="number" maxlength="10" />
        <label id="err_num">Please select preference</label><br>
         veg<input type="radio" name="preference_" value="1" /><br>
         non-veg<input type="radio" name="preference_"  value="0" /> 
